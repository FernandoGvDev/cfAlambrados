/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 18f89b770bb4ec5915a871ac689fd986)
// Runtime types generated with workerd@1.20260111.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* cf */;
